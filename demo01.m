...
close all;
clear all;
object_image = imread('demo_image\object\01.png');
fence_image = imread('demo_image\fence\01.png');
%Setup
...
% Extraction fences
f_img_sub_blur = imfilter(f_img_sub , h1, 'symmetric');
...
img_dil = ones();
img_imd = imdilate(sub_img_thin, img_dil);
...
subplot(3,3,7);imshow(sub_img_thin);
