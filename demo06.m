...
close all;
clear all;
object_image = imread('demo_image\object\06.JPG');
fence_image = imread('demo_image\fence\06.JPG');
% Setup
...
h2 = fspecial('gaussian',set1,set2*2);
